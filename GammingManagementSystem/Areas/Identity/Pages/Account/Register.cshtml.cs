...
namespace GammingManagementSystem.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            Input.ReferralCode = Request.Query["referralCode"];
            Input.Games = await _gameService.GetGames();
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                user.ReferalCodeBy = Input.ReferralCode;
                user.GameInterested = Input.GameInterested;
                user.RegistrationDate = DateTime.Now;
                var AgentEmail = checkRefAgent(user.ReferalCodeBy);
                ...
                if (result.Succeeded)
                {
                    ...
                    if (AgentEmail != null)
                    {
                        ...
                        var MailMessage = $"Player added using your Referral Code:{user.FirstName} {user.LastName}";
                        sendMail(user.Email, MailMessage, Subject);
                    }
        ...
        private string checkRefAgent(string refCode)
        {
            var EmailId = _context.ApplicationUser.
                Where(x => x.ReferalCode == refCode).Select(x => x.Email).FirstOrDefault();
